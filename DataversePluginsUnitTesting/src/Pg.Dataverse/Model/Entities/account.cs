...
namespace Pg.Dataverse.Model
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public static class Fields
		{
			...
			public const string pg_scoring = "pg_scoring";
		...
		public Microsoft.Xrm.Sdk.EntityReference pg_areaId
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("pg_areaid");
			}
			set
			{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("pg_scoring")]
		public virtual pg_scoring? pg_scoring
		{
			get
			{
				return ((pg_scoring?)(EntityOptionSetEnum.GetEnum(this, "pg_scoring")));
			}
			set
			{
				this.OnPropertyChanging("pg_scoring");
				this.SetAttributeValue("pg_scoring", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("pg_scoring");
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Pg.Dataverse.Model.Account> Referencedaccount_master_account
		{
			get
			{
				return this.GetRelatedEntities<Pg.Dataverse.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_master_account");
				this.SetRelatedEntities<Pg.Dataverse.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Pg.Dataverse.Model.Account> Referencedaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntities<Pg.Dataverse.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_parent_account");
				this.SetRelatedEntities<Pg.Dataverse.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Pg.Dataverse.Model.Account> Referencedmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntities<Pg.Dataverse.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedmsa_account_managingpartner");
				this.SetRelatedEntities<Pg.Dataverse.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public Pg.Dataverse.Model.Account Referencingaccount_master_account
		{
			get
			{
				return this.GetRelatedEntity<Pg.Dataverse.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public Pg.Dataverse.Model.Account Referencingaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntity<Pg.Dataverse.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingaccount_parent_account");
				this.SetRelatedEntity<Pg.Dataverse.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Pg.Dataverse.Model.Account Referencingmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<Pg.Dataverse.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingmsa_account_managingpartner");
				this.SetRelatedEntity<Pg.Dataverse.Model.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
				this.OnPropertyChanged("Referencingmsa_account_managingpartner");
			}
		}
		
		/// <summary>
		/// N:1 pg_account_areaId_pg_area
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("pg_areaid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("pg_account_areaId_pg_area")]
		public Pg.Dataverse.Model.pg_area pg_account_areaId_pg_area
		{
			get
			{
				return this.GetRelatedEntity<Pg.Dataverse.Model.pg_area>("pg_account_areaId_pg_area", null);
			}
			set
			{
				this.OnPropertyChanging("pg_account_areaId_pg_area");
				this.SetRelatedEntity<Pg.Dataverse.Model.pg_area>("pg_account_areaId_pg_area", null, value);
